...
const MEETING_QUESTIONS = [
  { key: "brandDealPct", label: "Que percentagem vem de brand deals vs produtos proprios?" },
  { key: "previousSales", label: "Ja vendeste algo diretamente? O que, a que preco, quantos?" },
  { key: "followerQuestions", label: "Que perguntas os teus seguidores te fazem mais?" },
  { key: "topContent", label: "Que tipo de conteudo costuma ter mais alcance? E mais engagement?" },
  { key: "dmTopics", label: "Sobre o que te mandam DMs?" },
  { key: "audienceProblem", label: "Se pudesses resolver um problema da tua audiencia, qual seria?" },
  { key: "emailList", label: "Tens lista de email? Quantos subscritores?" },
  { key: "storyViewRate", label: "Qual e a media de views nos stories?" },
